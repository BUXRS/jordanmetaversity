...
export default function NewsRelated({ newsItems, currentNewsSlug }: NewsRelatedProps) {
  // Filter out the current news and limit to 3 items
  const filteredNews = newsItems.filter((item) => item.slug !== currentNewsSlug).slice(0, 3)
